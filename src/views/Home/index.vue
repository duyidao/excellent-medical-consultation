    ...
    <div class="home-page">
        ...
        <div class="home-header">
            <div class="con">
                <h1>优医</h1>
                <div class="search">
                    <MySvgIcon name="home-search" /> 搜一搜：疾病/症状/医生/健康知识
                </div>
            </div>
        </div>
        ...
        <div class="home-navs">
            <van-row>
                <van-col span="8">
                    <router-link to="/"
                        class="nav">
                        <MySvgIcon name="home-doctor"></MySvgIcon>
                        <p class="title">问医生</p>
                ...
                <van-col span="8">
                    <router-link to="/"
                        class="nav">
                        <MySvgIcon name="home-prescribe"></MySvgIcon>
            ...
            <van-row>
                <van-col span="6">
                    <router-link to="/"
                        class="nav min">
                        <MySvgIcon name="home-order"></MySvgIcon>
                ...
                <van-col span="6">
                    <router-link to="/"
                        class="nav min">
                        <MySvgIcon name="home-docs"></MySvgIcon>
                ...
                <van-col span="6">
                    <router-link to="/"
                        class="nav min">
                        <MySvgIcon name="home-rp"></MySvgIcon>
                ...
                <van-col span="6">
                    <router-link to="/"
                        class="nav min">
                        <MySvgIcon name="home-find"></MySvgIcon>
